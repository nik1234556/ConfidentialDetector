...
// ConfidentialDetector.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CConfidentialDetectorApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CConfidentialDetectorApp

CConfidentialDetectorApp::CConfidentialDetectorApp()
{
...
// Единственный объект CConfidentialDetectorApp

CConfidentialDetectorApp theApp;


// Инициализация CConfidentialDetectorApp

BOOL CConfidentialDetectorApp::InitInstance()
{
